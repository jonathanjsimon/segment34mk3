...
class Segment34View extends WatchUi.WatchFace {
    ...
    hidden function setColorTheme(theme as Number) as Array<Graphics.ColorType> {
        ...
        if(theme == 1 ) { return [0x000000, 0xff85c2, 0x0F3B46, 0xFFD9FC, 0xbffff9, 0x0E333C, 0xff85c2, 0xffe6f2, 0xbf7498, 0xFF55AA, 0xFF55AA, 0x4cb2db, 0xFFFFFF]; } // Hot pink AMOLED
        ...
        if(theme == 8 ) { return [0x000000, 0xffd762, 0x182642, 0xFBDDA8, 0xfff5d9, 0x182642, 0x5890ff, 0xffe69a, 0xa89252, 0x5890ff, 0xff9f45, 0x5890ff, 0xFFFFFF]; } // Yellow on Blue AMOLED
